...
//bbruntime
	...
	BBSDK_API int bbBeginBlitz3DEx( int hwnd,int flags );
	BBSDK_API void bbEndBlitz3D();

	BBSDK_API int bbValidateGraphics();
...
// bbgraphics
...
#ifdef __cplusplus
	BBSDK_API void bbGraphics3D( int width,int height,int depth=0,int mode=0 );
#else
	BBSDK_API void bbGraphics3D( int width,int height,int depth,int mode );
#endif
	...
	BBSDK_API void bbBufferDirty( BBCanvas buffer );
	BBSDK_API void bbAutoBufferDirty( int enable );
...
// bbgraphics3d
	...
	BBSDK_API BBTexture bbCreateTexture( int w,int h,int flags=0,int frames=1 );
#else
	...
	BBSDK_API BBBrush bbLoadBrush( const char *file,int texture_flags=1,float u_scale=1.0,float v_scale=1.0 );
#else
	...
	BBSDK_API BBSprite bbLoadSprite( const char *file,int texture_flags=1,BBEntity p=0 );
#else
...
#ifdef __cplusplus
	BBSDK_API float bbEntityX( BBEntity e,int global=0 );
	BBSDK_API float bbEntityY( BBEntity e,int global=0 );
	BBSDK_API float bbEntityZ( BBEntity e,int global=0 );
	BBSDK_API float bbEntityPitch( BBEntity e,int global=0 );
	BBSDK_API float bbEntityYaw( BBEntity e,int global=0 );
	BBSDK_API float bbEntityRoll( BBEntity e,int global=0 );
#else
...
#ifdef __cplusplus
	BBSDK_API void bbTurnEntity( BBEntity e,float p,float y,float r,int global=0 );
	BBSDK_API void bbTranslateEntity( BBEntity e,float x,float y,float z,int global=0 );
	BBSDK_API void bbPositionEntity( BBEntity e,float x,float y,float z,int global=0 );
	BBSDK_API void bbScaleEntity( BBEntity e,float x,float y,float z,int global=0 );
	BBSDK_API void bbRotateEntity( BBEntity e,float p,float y,float r,int global=0 );
